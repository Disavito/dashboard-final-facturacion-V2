export const INVOICING_API_BASE_URL = 'https://n8n-api-sunat-2.mv7mvl.easypanel.host/api/v1';

// CRÍTICO: Token de autorización real de su API (Laravel Sanctum/Passport token)
export const INVOICING_API_AUTH_TOKEN = '3|sunat_prod_SWWEKxZcRNRs28v7cAU8f6rsljlHxFufmIwFm8FF02cf6de7'; 
